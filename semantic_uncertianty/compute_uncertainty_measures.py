...
def main(args):
    ...
    if args.assign_new_wandb_id:
        ...
        def restore(filename):
            if args.local_reload_path is None:
        ...
        if args.local_reload_path is not None:
        ...
        def restore(filename):
            class Restored:
                if args.local_reload_path is not None:
                    name = f'{args.local_reload_path}/files/{filename}'
                else:
                    name = f'{wandb.run.dir}/{filename}'
            return Restored
    ...
    for idx, tid in enumerate(validation_generations):
        ...
        # # load the embedding if compute_p_ik is enabled
